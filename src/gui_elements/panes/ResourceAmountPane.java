...
public class ResourceAmountPane extends MainPane {
    ...
    private static final String CATCH_IO_EXCEPTION_STRING = "Resource amount pane file input does not exist!";
	private static final String FINALLY_IO_EXCEPTION_STRING = "Resource amount pane file input cannot close!";
