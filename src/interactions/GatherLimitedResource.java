...
public class GatherLimitedResource implements CustomFunction {

	public final String NAME = "GatherLimitedResource";
	...
	public void setParameterFormatFields() {
		...
		format.addHelpText("This function modifies the resource stockpile upon interaction but it also "
				+ "reduces the resource value in the resource object.");
